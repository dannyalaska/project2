...
$(document).keypress(function(event){
      ...
      if(keycode == '97'){
          drumstick();
          $("#main-container").css("background-color", "#16a085")
      };
      if(keycode == '115'){
          pedal();
          $("#main-container").css("background-color", "#e74c3c")

      };
      if(keycode == '108'|| keycode == '107'){
          tiss();
          $("#main-container").css("background-color", "#eb19a5")
      };
      if(keycode == '116' || keycode == '121' ){
          boom();
          $("#main-container").css("background-color", "#f1c40f")
      };
      if(keycode == '103' || keycode == '104' ){
          boom2();
          $("#main-container").css("background-color", "#3498db")
      };
      if(keycode == '32'){
          ding();
          $("#main-container").css("background-color", "#8e44ad")
      };
      if(keycode == '98'){
          ping();
          $("#main-container").css("background-color", "#34495e")
      };
      if(keycode == '118'){
          blast();
          $("#main-container").css("background-color", "#2ecc71")
      };
      if(keycode == '112'){
          start();
          $("#main-container").css("background-color", "#bdc3c7")
      };
